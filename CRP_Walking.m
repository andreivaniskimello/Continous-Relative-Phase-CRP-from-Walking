        ...
        % CRP Calculation
            ...
            CRP_ShankFoot_Total_SD = mean(CRP_ShankFoot_AllStrides_Matrix_SD);
               ...
               %One row from the FINAL export matrix per input file
                  ...
                  CRP_Matrix_Export(k,:) = [CRP_ShankFoot_Export, CRP_ThighShank_Export, CRP_TrunkThigh_Export, CRP_KneeAnkle_Export, CRP_HipKnee_Export];
...
%         CRP_Curves_ShankFoot_Export_Mean_Knee_Two(:,k) =  [File; Depth; Speed; CRP_Curves_ShankFoot_Export_Mean(:,k)];
        CRP_Curves_ShankFoot_Export_Mean_Knee_Two(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
        CRP_Curves_ThighShank_Export_Mean_Knee_Two(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
        CRP_Curves_TrunkThigh_Export_Mean_Knee_Two(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
        CRP_Curves_KneeAnkle_Export_Mean_Knee_Two(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
        CRP_Curves_HipKnee_Export_Mean_Knee_Two(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
    elseif Depth == 1 && Speed == 2
         CRP_Curves_ShankFoot_Export_Mean_Knee_Four(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Knee_Four(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Knee_Four(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Knee_Four(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Knee_Four(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
            
    elseif Depth == 1 && Speed == 3
         CRP_Curves_ShankFoot_Export_Mean_Knee_Six(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Knee_Six(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Knee_Six(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Knee_Six(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Knee_Six(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
     elseif Depth == 1 && Speed == 4
         CRP_Curves_ShankFoot_Export_Mean_Knee_Eight(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Knee_Eight(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Knee_Eight(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Knee_Eight(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Knee_Eight(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
    elseif Depth == 2 && Speed == 1
        CRP_Curves_ShankFoot_Export_Mean_Hip_Two(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
        CRP_Curves_ThighShank_Export_Mean_Hip_Two(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
        CRP_Curves_TrunkThigh_Export_Mean_Hip_Two(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
        CRP_Curves_KneeAnkle_Export_Mean_Hip_Two(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
        CRP_Curves_HipKnee_Export_Mean_Hip_Two(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
    elseif Depth == 2 && Speed == 2
         CRP_Curves_ShankFoot_Export_Mean_Hip_Four(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Hip_Four(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Hip_Four(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Hip_Four(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Hip_Four(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
                     
    elseif Depth == 2 && Speed == 3
         CRP_Curves_ShankFoot_Export_Mean_Hip_Six(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Hip_Six(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Hip_Six(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Hip_Six(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Hip_Six(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
     elseif Depth == 2 && Speed == 4
         CRP_Curves_ShankFoot_Export_Mean_Hip_Eight(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Hip_Eight(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Hip_Eight(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Hip_Eight(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Hip_Eight(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
     elseif Depth == 3 && Speed == 1
        CRP_Curves_ShankFoot_Export_Mean_Umbilical_Two(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
        CRP_Curves_ThighShank_Export_Mean_Umbilical_Two(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
        CRP_Curves_TrunkThigh_Export_Mean_Umbilical_Two(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
        CRP_Curves_KneeAnkle_Export_Mean_Umbilical_Two(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
        CRP_Curves_HipKnee_Export_Mean_Umbilical_Two(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
    elseif Depth == 3 && Speed == 2
         CRP_Curves_ShankFoot_Export_Mean_Umbilical_Four(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Umbilical_Four(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Umbilical_Four(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Umbilical_Four(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Umbilical_Four(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
            
    elseif Depth == 3 && Speed == 3
         CRP_Curves_ShankFoot_Export_Mean_Umbilical_Six(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Umbilical_Six(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Umbilical_Six(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Umbilical_Six(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Umbilical_Six(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
     elseif Depth == 3 && Speed == 4
         CRP_Curves_ShankFoot_Export_Mean_Umbilical_Eight(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Umbilical_Eight(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Umbilical_Eight(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Umbilical_Eight(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Umbilical_Eight(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
              
    elseif Depth == 4 && Speed == 1
        CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Two(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
        CRP_Curves_ThighShank_Export_Mean_Xiphoid_Two(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
        CRP_Curves_TrunkThigh_Export_Mean_Xiphoid_Two(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
        CRP_Curves_KneeAnkle_Export_Mean_Xiphoid_Two(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
        CRP_Curves_HipKnee_Export_Mean_Xiphoid_Two(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
    elseif Depth == 4 && Speed == 2
        CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Four(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
        CRP_Curves_ThighShank_Export_Mean_Xiphoid_Four(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
        CRP_Curves_TrunkThigh_Export_Mean_Xiphoid_Four(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
        CRP_Curves_KneeAnkle_Export_Mean_Xiphoid_Four(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
        CRP_Curves_HipKnee_Export_Mean_Xiphoid_Four(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
            
    elseif Depth == 4 && Speed == 3
         CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Six(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Xiphoid_Six(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Xiphoid_Six(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Xiphoid_Six(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Xiphoid_Six(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
         
     elseif Depth == 4 && Speed == 4
         CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Eight(:,k) =  CRP_Curves_ShankFoot_Export_Mean(:,k);
         CRP_Curves_ThighShank_Export_Mean_Xiphoid_Eight(:,k) =  CRP_Curves_ThighShank_Export_Mean(:,k);
         CRP_Curves_TrunkThigh_Export_Mean_Xiphoid_Eight(:,k) =  CRP_Curves_TrunkThigh_Export_Mean(:,k);
        
         CRP_Curves_KneeAnkle_Export_Mean_Xiphoid_Eight(:,k) =  CRP_Curves_KneeAnkle_Export_Mean(:,k);
         CRP_Curves_HipKnee_Export_Mean_Xiphoid_Eight(:,k) =  CRP_Curves_HipKnee_Export_Mean(:,k);
...
% Export CRP Curve 0-100% ShankFoot

    %Delete NaN and Zero columns
...
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Knee_Two, 1); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Knee_Four, 2); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Knee_Six, 3); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Knee_Eight, 4); 

xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Hip_Two, 5); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Hip_Four, 6); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Hip_Six, 7); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Hip_Eight, 8); 

xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Umbilical_Two, 9); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Umbilical_Four, 10); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Umbilical_Six, 11); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Umbilical_Eight, 12); 

xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Two, 13); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Four, 14); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Six, 15); 
xlswrite(Output_File_Path_CRP_Curves_ShankFoot, CRP_Curves_ShankFoot_Export_Mean_Xiphoid_Eight, 16); 
